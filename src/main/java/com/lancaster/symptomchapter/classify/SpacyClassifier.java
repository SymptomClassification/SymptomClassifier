...
public class SpacyClassifier {
    ...
    public List<Map<String, String>> multiLabelSymptom(String symptom) throws IOException, InterruptedException {
        List<String> command = new ArrayList<>();
        command.add("python3");
        command.add("target/multiLabelClassification/classify.py");
        command.add(symptom);
